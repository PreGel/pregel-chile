  ...
  <html class="no-js"  <?php language_attributes(); ?>>
	...
	<head>
		...
		<?php if ( ! function_exists( 'has_site_icon' ) || ! has_site_icon() ) { ?>
	    	...
	    	<meta name="description" content="PreGel Chile ofrece soluciones especiales de ingredientes para postres, resultado de una intensa investigación, innovación de vanguardia y trabajo duro tradicional.">
	    <?php } ?>

		<link rel="pingback" href="<?php bloginfo('pingback_url'); ?>">
		<link rel="alternate" href="https://pregelchile.com/" hreflang="es-cl" />
